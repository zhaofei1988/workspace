...
<html>
<head>
<title>NumberOne专业开发  微信公众账号开发平台</title>
...
<!-- 顶部-->
<div region="north" border="false" title="NumberOne专业开发" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" style="vertical-align: text-bottom;"><img src=""></td>
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://360ifish.com" title="NumberOne专业开发 微信公众账号开发平台">NumberOne专业开发</a> (推荐谷歌浏览器，获得更快响应速度)</span></div>
</div>
